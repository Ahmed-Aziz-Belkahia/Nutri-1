...
export function registerRoutes(app: Express): Server {
  ...
  app.post("/api/meal-plans/generate-optimized", requireAuth, async (req: AuthRequest, res: Response) => {
    try {
      ...
      // REMOVED: Manual shopping list generation
      // Shopping list is now generated by the dedicated AI-powered service
      // This prevents duplicate non-consolidated ingredients from being inserted
      
      console.log(`Saved ${savedRecipes.length} recipes for optimized meal plan`);

      // Return the created meal plan with recipes
      res.json({
        mealPlan: {
          ...newMealPlan,
          recipes: savedRecipes
        },
        message: 'Optimized meal plan created successfully. Shopping list will be generated by AI service.'
      });
