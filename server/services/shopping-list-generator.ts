...
/**
 * Generate a weekly shopping list for multiple meal plans (one for the entire week)
 */
export async function generateWeeklyShoppingList(mealPlanIds: number[], userId: number) {
  console.log(`Generating weekly shopping list for ${mealPlanIds.length} meal plans`);
