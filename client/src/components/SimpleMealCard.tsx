...
export function SimpleMealCard({ meal, onToggleComplete, onClick }: SimpleMealCardProps) {
  const { t } = useTranslation();
  
  // Function to simplify meal names by extracting just the main part
  const getSimplifiedMealName = (name: string): string => {
    ...
    // This will keep "tortilla-breast" from "tortilla-breast Lunch (Day 2) with wheat tortilla with..."
  ...
  return (
    ...
    >
      <div className="flex items-center p-3">
        ...
        {/* Meal Info with simplified name */}
