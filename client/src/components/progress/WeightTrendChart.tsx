...
export const WeightTrendChart: React.FC<Props> = ({ weightLogs, goalWeight, loading }) => {
  ...
  if (!data.length) {
    return <Card className="p-4 rounded-2xl text-sm text-gray-500">Add weight logs to see your trend.</Card>;
  }
      ...
      <div className="h-48 -ml-2">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={{ left: 0, right: 0, top: 10, bottom: 0 }}>
            ...
            {goalWeight && <ReferenceLine y={goalWeight} stroke="#0CC5BA" strokeDasharray="4 4" label={{ value: 'Goal', position: 'right', fill: '#0CC5BA', fontSize: 11 }} />}
